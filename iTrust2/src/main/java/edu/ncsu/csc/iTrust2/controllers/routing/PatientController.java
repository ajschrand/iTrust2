...
public class PatientController {
    ...
    /**
     * Create a page for the patient to manage their advocates
     *
     * @param model
     *            data for front end
     * @return The page for the patient to view bills
     */
    @GetMapping ( value = "patient/manageAdvocates" )
    @PreAuthorize ( "hasRole('ROLE_PATIENT')" )
    public String manageAdvocates ( final Model model ) {
        return "/patient/manageAdvocates";
    }
